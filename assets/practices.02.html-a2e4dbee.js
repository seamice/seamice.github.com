import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as n,f as t}from"./app-3c4d73c2.js";const a={},s=t(`<h2 id="week-7-latent-dirichlet-allocation-practical-6" tabindex="-1"><a class="header-anchor" href="#week-7-latent-dirichlet-allocation-practical-6" aria-hidden="true">#</a> Week 7: Latent Dirichlet Allocation (Practical 6)</h2><p>In this practical, we will process the text data that includes the abstracts of all papers in the Journal of Statistical Software (JSS), up to 08/05/2010.<br> The JSS data is available as a list matrix in the package corpus.JSS.papers which can be<br> installed and loaded by:</p><div class="language-R line-numbers-mode" data-ext="R"><pre class="language-R"><code>### Download the collection of abstracts of the Journal of Statistical Software (JSS)
