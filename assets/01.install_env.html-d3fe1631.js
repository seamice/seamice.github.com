import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o,c,b as n,d as e,e as a,f as i}from"./app-85bd57df.js";const r={},d={id:"install-norminette",tabindex:"-1"},p=n("a",{class:"header-anchor",href:"#install-norminette","aria-hidden":"true"},"#",-1),m={href:"https://github.com/42School/norminette",target:"_blank",rel:"noopener noreferrer"},u=i(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># The plugin only avaliable on vim</span>
