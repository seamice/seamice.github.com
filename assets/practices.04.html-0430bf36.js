...
ptv
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,21),u={href:"https://cran.r",target:"_blank",rel:"noopener noreferrer"},v={href:"http://project.org/web/packages/maps/maps.pdf",target:"_blank",rel:"noopener noreferrer"},p=t(`<div class="language-R line-numbers-mode" data-ext="R"><pre class="language-R"><code>require(maps)
data(canada.cities)
head(canada.cities)
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,35),g={class:"hint-container info"},f=e("p",{class:"hint-container-title"},"Note",-1),R=e("br",null,null,-1),y=e("a",{href:"HTTPS://CRAN.R"},"HTTPS://CRAN.R",-1),q={href:"http://PROJECT.ORG/WEB/PACKAGES/RNATURALEARTH/VIGNETTES/RNATURALEARTH.HTML",target:"_blank",rel:"noopener noreferrer"},x=t(`<ul><li>Spatial vectors returned by rnaturalearth are objects from <code>sp</code> (outdated ‐ default) or <code>sf</code> packages. Use the vect function from the terra package to convert them to <code>SpatVector</code> objects. This let you use <code>terra</code> capabilities in vectors from <code>rnaturalearth</code> (e.g. color the map by using a categorical variable)</li></ul><div class="language-R line-numbers-mode" data-ext="R"><pre class="language-R"><code>colombiaShape &lt;- vect(ne_states(country = &quot;colombia&quot;))
colombiaShape
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3);function w(_,E){const i=l("ExternalLinkIcon");return r(),d("div",null,[c,e("ul",null,[e("li",null,[a("You can also create a SpatVector from a data frame. The following code creates a vector (geometry: points) with the coordinates of cities in Ontario ‐ Canada. We use the maps package that has useful information about cities and maps of the world (see "),e("a",u,[a("https://cran.r"),n(i)]),a("‐"),e("a",v,[a("project.org/web/packages/maps/maps.pdf"),n(i)]),a(").")])]),p,e("ul",null,[e("li",null,[a("Let’s include the borders from a shape file to the cities for Ontario. We have downloaded the shape file used in this example from Ontario Ministry of Natural Resources and Forestry at "),e("a",m,[a("https://geohub.lio.gov.on.ca/maps/mnr‐district"),n(i)]),a(".")]),h]),b,e("div",g,[f,e("p",null,[a("A LIST OF VECTOR LAYERS AVAILABLE VIA ne_download(type=[layer_name], scale=)"),R,a(" CAN BE FOUND AT: "),y,a("‐"),e("a",q,[a("PROJECT.ORG/WEB/PACKAGES/RNATURALEARTH/VIGNETTES/RNATURALEARTH.HTML"),n(i)])])]),x])}const A=s(o,[["render",w],["__file","practices.04.html.vue"]]);export{A as default};
